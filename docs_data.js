    ...
    return {
        pt: {
            ...
            base: [
                ...
                ['isTemporary', 'Se for true, o acesso ao conteúdo do modal é temporário e o Lightbox é totalmente destruído após o tempo limite, tornando obrigatório o envio do parâmetro duration.'],
                ['duration', 'Se isTemporary for true, é obrigatório passar o duration como uma string no formato de horas, minutos e segundos (HH:MM:SS). Se não for enviado nenhum valor, o padrão será "00:10:00" antes do Lightbox ser destruído.'],
            ...
            types: [
                ...
                ['Configuração para tipo: "form"', 'Suporta o controle de validação e envio: method: (GET, POST, PUT, DELETE, PATCH), action (string), submitText, resetText (string), showReset (boolean), onsubmit (string, Nome da função de callback), autoClose (boolean, se true fecha automaticamente o lightbox após a execução do onsubmit).']
            ],
            context: [
        ...
        en: {
            ...
            base: [
                ...
                ['isTemporary', 'If true, access to the modal content is temporary and the Lightbox is completely destroyed after the time limit, making the duration parameter mandatory.'],
                ['duration', 'If isTemporary is true, duration must be passed as a string in hours, minutes, and seconds format (HH:MM:SS). If no value is provided, it defaults to "00:10:00" before the Lightbox is destroyed.'],
            ...
            types: [
                ...
                ['Configuration for type: "form"', 'Supports validation and submission control: method: (GET, POST, PUT, DELETE, PATCH), action (string), submitText, resetText (string), showReset (boolean), onsubmit (string, Name of the callback function), autoClose (boolean, if true it automatically closes the lightbox after onsubmit execution).']
            ],
            context: [
