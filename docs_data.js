    ...
    return {
        pt: {
            ...
            types: [
                ...
                ['Configuração para tipo: "map"', 'Suporta as chaves de dados: locais (array de objetos contendo nome, x, y, cor [código hex] e formato [circle, square]).'],
        ...
        en: {
            ...
            types: [
                ...
                ['Configuration for type: "map"', 'Accepts an object with data keys: locais (array of objects containing nome, x, y, cor [hex code], and formato [circle, square]).'],
