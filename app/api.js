...
function fsmodal_create(optiy, app) {
    ...
    if (optiy) {
        ...
        if (optiy.context && optiy.context != "") {
            ...
            fsmodal_createdd += `<div style="height: height:${Number(optiy.size)}px; position: absolute; width: 100%;   padding:5px; text-align:center; color:#fff;">${fsmodal_create_ifir} ${fsmodal_create_desci}<br/><br/><br/><br/></div><br/><br/><br/>`;
        }
