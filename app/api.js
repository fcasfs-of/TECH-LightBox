    ...
    if (optiy) {
        ...
        if (optiy.context && optiy.context != "") {
            ...
            if (app && app == "yes" && optiy.type && optiy.type == "id") {
                ...
                is_player0j = "no";
                fsmodal_create_ifir = `<div id="table_fcaslight"${fcas_lightbox_table({ containerId: "table_fcaslight", showIndex: false, list: optiy.context, perPage: 12,    page: 1, minWidth: '100%', model: 'indigo', zebra: true, align: 'left', headerAlign: 'center',    headerBold: true, borderRadius: '10px', borderWidth: '2px', borderStyle: 'ridge', borderRadius: '9px', padding: '6px 11px' })}></div>`;
