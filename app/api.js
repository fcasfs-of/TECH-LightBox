...
function fcasfs_lightbox_executarAposTempo(obj,tt) { if (obj && tt && typeof obj.callback === 'function') { if (obj.wait && typeof obj.wait === 'number') { var fcasfs_lightbox_exet = setTimeout(function() { obj.callback(tt); clearTimeout(fcasfs_lightbox_exet); }, obj.wait); } else obj.callback(tt); } }
...
function fsmodal_open(optiy){   fcasfs_lightbox_executarAposTempo({ callback: fcas_lightbox_fsmodal_open, wait: optiy.wait || "" }, optiy);   }
