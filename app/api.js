...
function isadl_noeadult(){    fsmodal_close(optiy.id, optiy.scroll_hide);  }
function isadl_yeseadult(){   optiy.isAdult=false;   fsmodal_open(optiy);  isadl_noeadult();   }
...
if (optiy.isAdult && optiy.isAdult===true){   fcaslightconetxndif_isnort=fcafs_lightbox_gerarAvisoConteudoAdulto({isAdult:optiy.isAdult, lang: fcas_lightbox_checkValueEX(optiy,"config","Lang","en") || "en", onNo:"isadl_noeadult();", onYes:"isadl_yeseadult();"});   }
