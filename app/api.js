...
<style>  #fs_modal_${optiy.id}, #fs_modal_${optiy.id}_content, #fs_modal_${optiy.id} *, #fs_modal_${optiy.id}_content * {  color:#${fcas_lightbox_checkValueEX(optiy.content,"config","colorText","fff") || "fff"} !important;  }  </style>
                <div id="cf_menuu"></div>
            `;
