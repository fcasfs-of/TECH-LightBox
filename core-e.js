...
window.addEventListener('load',function(){const act=new URLSearchParams(window.location.search).get('button')||'';if(act!==''){const btn=document.querySelector(`.nav-menu .cat-group button#btn${act}`);if(btn){btn.click();}}});
