...
function fcas_criarBarraBusca(wrapper,isPt){const sw=document.createElement('div');sw.className='fcas-search-wrapper';sw.innerHTML='<div class="fcas-search-container"><svg class="fcas-search-icon" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg><input type="text" class="fcas-search-input" placeholder="'+(isPt?'Buscar botões...':'Search buttons...')+'"><button class="fcas-search-clear" type="button"><svg viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg></button></div><div class="fcas-search-results"></div>';wrapper.parentNode.insertBefore(sw,wrapper);return sw;}
function fcas_renderizarHTMLMenu(config,isPt,nav,sidebar){let htmlMenu='',totalGeral=0;config.categorias.forEach(function(g){if(g&&Array.isArray(g.botoes))totalGeral+=g.botoes.length});const temIcons=typeof fcasfs_ligh_cate_icons!=='undefined',iconeAll=temIcons&&fcasfs_ligh_cate_icons['Todos']?fcasfs_ligh_cate_icons['Todos']:'';let htmlSidebar='<button class="fcas-sidebar-item active" data-target="all">'+iconeAll+(isPt?'Todos':'All')+'<span class="fcas-badge">'+totalGeral+'</span></button><hr class="fcas-sidebar-divider">';config.categorias.forEach(function(g){if(g&&typeof g==='object'&&typeof g.nome==='string'&&Array.isArray(g.botoes)){const iconeSvg=temIcons&&fcasfs_ligh_cate_icons[g.nome]?fcasfs_ligh_cate_icons[g.nome]:'',gid='fcas-grupo-'+g.nome.replaceAll(' ','');htmlMenu+='<div class="cat-group" id="'+gid+'"><h3>'+iconeSvg+g.nome+' ('+g.botoes.length+')</h3>';g.botoes.forEach(function(b){if(b&&typeof b==='object'&&typeof b.id==='string'&&typeof b.texto==='string'){htmlMenu+='<button id="'+b.id+'">'+b.texto+'</button>'}});htmlMenu+='</div>';htmlSidebar+='<button class="fcas-sidebar-item" data-target="'+gid+'">'+iconeSvg+g.nome+'<span class="fcas-badge">'+g.botoes.length+'</span></button>'}});nav.innerHTML=htmlMenu;sidebar.innerHTML=htmlSidebar;}
...
const fcasfs_ligh_cate_icons = {
  ...
  "Text & Links": "<svg width=\"24px\" height=\"24px\" viewBox=\"0 0 52 52\"><path d=\"M18,16h-6v10h6 M12,21h6\" stroke=\"black\" stroke-width=\"4\" fill=\"none\"/><path d=\"M32,29c-4-4,0-8,4-4l6,6c4,4,0,8-4,4l-3-3\" stroke=\"black\" stroke-width=\"4\" fill=\"none\"/><path d=\"M29,32c4,4,0,8-4,4l-6-6c-4-4,0-8,4-4l3,3\" stroke=\"black\" stroke-width=\"4\" fill=\"none\"/></svg>",
  ...
  "Utility-focused & Dynamic": "<svg width=\"24px\" height=\"24px\" viewBox=\"0 0 52 52\"><path d=\"M42,22c0-8.8-7.2-16-16-16S10,13.2,10,22c0,7.1,4.6,13.1,11,15.2V46h10v-8.8C37.4,35.1,42,29.1,42,22z M26,34c-6.6,0-12-5.4-12-12s5.4-12,12-12s12,5.4,12,12S32.6,34,26,34z\"/><polygon points=\"26,14 22,22 26,22 24,30 30,20 26,20\"/></svg>",
  ...
  "Texto & Links": "<svg width=\"24px\" height=\"24px\" viewBox=\"0 0 52 52\"><path d=\"M18,16h-6v10h6 M12,21h6\" stroke=\"black\" stroke-width=\"4\" fill=\"none\"/><path d=\"M32,29c-4-4,0-8,4-4l6,6c4,4,0,8-4,4l-3-3\" stroke=\"black\" stroke-width=\"4\" fill=\"none\"/><path d=\"M29,32c4,4,0,8-4,4l-6-6c-4-4,0-8,4-4l3,3\" stroke=\"black\" stroke-width=\"4\" fill=\"none\" /></svg>",
  ...
  "Utilitários & Dinâmicos": "<svg width=\"24px\" height=\"24px\" viewBox=\"0 0 52 52\"><path d=\"M42,22c0-8.8-7.2-16-16-16S10,13.2,10,22c0,7.1,4.6,13.1,11,15.2V46h10v-8.8C37.4,35.1,42,29.1,42,22z M26,34c-6.6,0-12-5.4-12-12s5.4-12,12-12s12,5.4,12,12S32.6,34,26,34z\"/><polygon points=\"26,14 22,22 26,22 24,30 30,20 26,20\"/></svg>",
